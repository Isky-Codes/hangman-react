...
class Hangman extends Component {
  ...
  /** restartGame: restarts game by picking new randomWord() and reset guessed list and number of wrong guesses*/
  restartGame() {
    this.setState({ 
      nWrong: 0,
      guessed: new Set(),
    ...
    return (
      <div className='Hangman'>
        ...
        {((this.state.nWrong === this.props.maxWrong) ?
          <img src={this.props.images[this.props.maxWrong]} alt={altText} /> :
